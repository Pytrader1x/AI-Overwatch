...
from AI_capture import capture_frame_send
import datetime
    ...
    while True:
        ...
        if ans:
            ...
            for obj in ans:
                ...
                if "person" in label_text and datetime.datetime.now() > a:

                    print('found person')
                    capture_frame_send(color_image)
                    a = datetime.datetime.now() + datetime.timedelta(minutes=2)
